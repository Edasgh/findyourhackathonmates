...
export default function Team({
  ...
  return (
    <div
      key={index}
      className="team-card max-[800px]:h-[26rem] min-[800.1px]:h-[28rem] max-[800px]:w-[19rem] min-[800.1px]:w-[22rem] backdrop-blur-md m-auto"
    >
      <div className="team-card-inner p-7  flex flex-col gap-4 justify-center items-center border-[1px] border-textSecondary rounded-2xl">
        <div className="team-card-front flex flex-col gap-4 justify-center items-center">
          <CustomAvatar name={name} />
          <p className="text-textBgPrimaryHv">{name}</p>
          <p className="text-textPrimary text-xs">{desc}</p>
